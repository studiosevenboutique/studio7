  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: "url('/images/studiophoto1.jpg')",
      ...
      >
        <div className="max-w-2xl mx-auto mt-20 md:mt-40 px-4" style={{ fontFamily: 'var(--font-montserrat), system-ui, sans-serif' }}>
          <div
            className={`text-sm md:text-lg mb-6 md:mb-8 font-medium opacity-90 max-w-lg overflow-hidden text-center mx-auto transition-all duration-[2s] px-2 ${
              showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
          ...
          <div className={`flex flex-col sm:flex-row gap-3 sm:gap-4 mt-8 md:mt-12 justify-center px-4 transition-all duration-[2s] ${
            showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}
          ...
          >
            <Button
              size="lg"
              className={`bg-white text-charcoal border-2 border-white hover:bg-white/80 rounded-[200px] btn-3d px-8 sm:px-12 py-3 text-sm sm:text-base transition-all duration-[2s] ${
                showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
              }`}
